            ...
            <td class="px-4 py-4 text-sm whitespace-nowrap">
                <div class="flex items-center gap-x-6">
                    ...
                    <form method="post" action="">
                        <input type="hidden" name="cell_id" value="cell-' . $idCounter . '">
                        <button type="submit" name="delete' . $idCounter . '"   id="delete' . $idCounter . '" class="text-gray-300 transition-colors duration-200 hover:text-red-500 focus:outline-none">
